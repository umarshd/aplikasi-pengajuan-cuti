...
<head>
  ...
  <title>Pages / Forbiden 403</title>
    ...
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <?php if (session()->get('role') == 1) : ?>
          <a class="btn" href="<?= base_url() ?>/karyawan">Back to home</a>
        <?php elseif (session()->get('role') == 2) : ?>
          <a class="btn" href="<?= base_url() ?>/manager">Back to home</a>
        <?php elseif (session()->get('role') == 3) : ?>
          <a class="btn" href="i<?= base_url() ?>/seniormanager">Back to home</a>
        <?php endif ?>
        <img src="<?= base_url() ?>/assets/NiceAdmin/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
