<?= $this->extend('layouts/senior_manager_layout') ?>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <?php foreach ($cuties as $cuti) : ?>
                    <?php if ($cuti['status_cuti_id_by_senior_manager'] != null) : ?>
                      <tr>
                        <th><?= $i++ ?></th>
                        ...
                        <td>
                          <a href="<?= base_url('seniormanager/cuti/' . $cuti['id']) . '/detail' ?>" class="btn btn-info text-white"> <i class="bi bi-zoom-in"></i></a>
                        </td>
                      </tr>
                    <?php endif ?>
